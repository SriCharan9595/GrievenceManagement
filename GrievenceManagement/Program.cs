...
var connectionString = "server=localhost; port=3306; user=root; password=cheri@mysql; database=grievencemanagement";
var serverVersion = new MySqlServerVersion(new Version(8, 0, 28));

// Add services to the container.

builder.Services.AddDbContext<GrievenceManagementDbContext>(options =>
{
